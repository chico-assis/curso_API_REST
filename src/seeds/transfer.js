exports.seed = (knex) => {
  return knex('transactions').del()
    ...
    .then(() => knex('users').insert([
      { id: 10000, name: 'User #1', mail: 'user1@mail.com', passwd: '$2a$10$kCX8xqJDiJ1fGjwmYm.9NuSDS.c4HttOP6X85.9T97hjOhjENAzEe' },
      { id: 10001, name: 'User #2', mail: 'user2@mail.com', passwd: '$2a$10$kCX8xqJDiJ1fGjwmYm.9NuSDS.c4HttOP6X85.9T97hjOhjENAzEe' },
    ]))
    ...
    .then(() => knex('transfers').insert([
      ...
      { id: 10001, description: 'Transfer #1', user_id: 10001, acc_ori_id: 10002, acc_dest_id: 10003, amount: 100, date: new Date() },
    ]))
